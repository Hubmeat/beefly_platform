	...
	; (function (factory) {
		...
		var Pagination = function (element, options) {
			...
			this.filling = function (index) {
				...
				if (opts.keepShowPN || current > 4) {//上一页
					html += '<a href="javascript:;" class="' + opts.prevCls + '">' + opts.prevContent + '</a><span>...</span>';
				} else {
				...
				if (opts.keepShowPN || current < pageCount) {//下一页
					html += '<span>...</span><a href="javascript:;" class="' + opts.nextCls + '">' + opts.nextContent + '</a>'
				} else {
					if (opts.keepShowPN == false) {
