  ...
  <div class="settlementManager">
    <el-tabs v-model="activeName" @tab-click="getTabName" type="border-card">
                ...
                <!--dialog 弹窗开始-->
                 <el-dialog title="结算确认" :visible.sync="dialogVisible" :modal="true" :modal-append-to-body="false">
                    ...
                    <div slot="footer" class="dialog-footer">
                      <el-button class="partner_button" type="primary" v-loading.fullscreen.lock="fullscreenLoading" @click="editConfim(scope.row, scope.$index)">确定结算</el-button>
      ...
      <el-tab-pane label="已结算" name='已结算'>
        ...
        <el-row class="table">
          <el-table :data="tableData2" style="width: 100% font-size:13px; color: #6c6c6c;">
            <el-table-column prop="settle_date" label="结算月份" min-width="80">
            </el-table-column>
            <el-table-column prop="settle_money" label="结算金额" min-width="60">
            </el-table-column>
  ...
  methods: {
    ...
    tableDataDel (arr) {
      ...
      for (var i = 0; i < arr.length; i++) {
        ...
        obj.allianceId = arr[i].franchiseeId
        obj.remark = ''
