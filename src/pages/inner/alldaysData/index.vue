  ...
  <div class="allDays">
    <el-row class="DatePicker">
      <el-col style="background: #f3f0f0; padding: 20px;">
        <el-form :inline="true">
          <el-row class="selectPlace" style="margin-left: 10px;">
...
div.el-date-editor--datetimerange {
  margin-right: 8px;
}
</style>
<script>
...
export default {
  ...
  methods: {
    ...
    handleClick(e) {
      ...
      this.chartsTitle = e.target.innerText + '加盟商24小时数据走势'
    }
  }
}
</script>
